/* Automatically generated by gen_messages from /home/dino/paparazzi/conf/messages.xml */
/* Please DO NOT EDIT */
...
#define DOWNLINK_SEND_OPTIC_FLOW_EST(_trans, _dev, fps, corner_cnt, tracked_cnt, flow_x, flow_y, flow_der_x, flow_der_y, vel_x, vel_y, cmd_phi, cmd_theta) pprz_msg_send_OPTIC_FLOW_EST(&((_trans).trans_tx), &((_dev).device), AC_ID, fps, corner_cnt, tracked_cnt, flow_x, flow_y, flow_der_x, flow_der_y, vel_x, vel_y, cmd_phi, cmd_theta)
static inline void pprz_msg_send_OPTIC_FLOW_EST(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_fps, uint16_t *_corner_cnt, uint16_t *_tracked_cnt, int16_t *_flow_x, int16_t *_flow_y, int16_t *_flow_der_x, int16_t *_flow_der_y, float *_vel_x, float *_vel_y, int32_t *_cmd_phi, int32_t *_cmd_theta) {
	if (trans->check_available_space(trans->impl, dev, trans->size_of(trans->impl, 0+4+2+2+2+2+2+2+4+4+4+4 +2 /* msg header overhead */))) {
	  trans->count_bytes(trans->impl, dev, trans->size_of(trans->impl, 0+4+2+2+2+2+2+2+4+4+4+4 +2 /* msg header overhead */));
	  trans->start_message(trans->impl, dev, 0+4+2+2+2+2+2+2+4+4+4+4 +2 /* msg header overhead */);
	  trans->put_bytes(trans->impl, dev, DL_TYPE_UINT8, DL_FORMAT_SCALAR, 1, &ac_id);
...
#define DOWNLINK_SEND_OPTIC_FLOW_EST(_trans, _dev, fps, corner_cnt, tracked_cnt, flow_x, flow_y, flow_der_x, flow_der_y, vel_x, vel_y, cmd_phi, cmd_theta) {}
static inline void pprz_msg_send_OPTIC_FLOW_EST(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_fps __attribute__((unused)), uint16_t *_corner_cnt __attribute__((unused)), uint16_t *_tracked_cnt __attribute__((unused)), int16_t *_flow_x __attribute__((unused)), int16_t *_flow_y __attribute__((unused)), int16_t *_flow_der_x __attribute__((unused)), int16_t *_flow_der_y __attribute__((unused)), float *_vel_x __attribute__((unused)), float *_vel_y __attribute__((unused)), int32_t *_cmd_phi __attribute__((unused)), int32_t *_cmd_theta __attribute__((unused))) {}
...
#define DL_OPTIC_FLOW_EST_cmd_phi(_payload) ((int32_t)(*((uint8_t*)_payload+26)|*((uint8_t*)_payload+26+1)<<8|((uint32_t)*((uint8_t*)_payload+26+2))<<16|((uint32_t)*((uint8_t*)_payload+26+3))<<24))
#define DL_OPTIC_FLOW_EST_cmd_theta(_payload) ((int32_t)(*((uint8_t*)_payload+30)|*((uint8_t*)_payload+30+1)<<8|((uint32_t)*((uint8_t*)_payload+30+2))<<16|((uint32_t)*((uint8_t*)_payload+30+3))<<24))
